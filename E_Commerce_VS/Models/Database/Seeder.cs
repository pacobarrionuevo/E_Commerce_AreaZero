    ...
    public class Seeder
    {
        ...
        private async Task SeedImagesAsync()
        {
            Producto[] productos = new Producto[]
            {
                ...
                new Producto() { Id = 9, Nombre = "Pokemon Card Game Case", Ruta = "images/9.png", Precio = 2750, Stock = 10 },
                new Producto() { Id = 10, Nombre = "Sword & Shield: Lost Origin Pack", Ruta = "images/10.png", Precio = 500, Stock = 10 },
                ...
                new Producto() { Id = 16, Nombre = "Escarlata y Purpura: Mascara Crepuscular", Ruta = "images/16.png", Precio = 500, Stock = 10 },
                new Producto() { Id = 17, Nombre = "Sword & Shield: Silver Tempest", Ruta = "images/17.png", Precio = 500, Stock = 10 },
                new Producto() { Id = 18, Nombre = "Escarlata y Purpura: Llamas Obsidianas", Ruta = "images/18.png", Precio = 500, Stock = 10 },
                new Producto() { Id = 19, Nombre = "Escarlata y Purpura: Evoluciones En Paldea", Ruta = "images/19.png", Precio = 500, Stock = 10 },
                new Producto() { Id = 20, Nombre = "Sword & Shield: Evolving Skies", Ruta = "images/20.png", Precio = 500, Stock = 10 },
            };
