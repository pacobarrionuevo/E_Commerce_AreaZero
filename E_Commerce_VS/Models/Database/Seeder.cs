...
namespace E_Commerce_VS.Models.Database
{
    public class Seeder
    {
        ...
        private async Task SeedImagesAsync()
        {
            ...
            {
                //Los precios son invent, pero la verdad que nos da igual
            ...
            {
                //Llamenme antony fantano por las reviews que escribo
            ...
            Usuario[] usuarios = new Usuario[] {
                //Esperemos que te guste tu gmail y tu password jose :D
